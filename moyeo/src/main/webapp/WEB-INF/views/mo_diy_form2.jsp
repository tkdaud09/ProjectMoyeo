		...
		<div class="py-10">
			<div class="diy_content">
				...
				<div class="diy_form_content">
					...
					<!-- <form name="frm" method="post" target="ifrm" enctype="multipart/form-data" action="/email_ok.php"> -->
						...
						<div class="price_02">
								...
								<table>
									...
									<tbody>
										<tr>
											<td>출발/도착</td>
											<td><input class="input01"  type="text" placeholder="예시) 2023.08.18~2023.08.20" name="date" required></td>
										</tr>

										<tr>
											<td>인원</td>
											<td><input class="input01"  type="text" placeholder="예시) 4명" name="people" required></td>
										</tr>

										<tr>
											<td>지역</td>
											<td><input class="input01"  type="text" placeholder="예시) 부산" name="loc" required></td>
										</tr>

										<tr>
											<td>경비</td>
											<td><input class="input01"  type="text" placeholder="예시) 100만원" name="price" required></td>
										</tr>
										...
										<!-- <tr>
											<td class="map_spot_left" colspan='2'>지도 API가 들어갈 공간</td>
										</tr>	
										<tr>
										...
										<tr>
											<td>제목</td>
											<td><input class="input01"  type="text" placeholder="예시) 100만원" name="title" required></td>
										</tr>

										<tr>
											<td>특이사항</td>
											<td>
												<textarea class="textarea" name="memo" id="" cols="30" rows="5" placeholder="내용"></textarea>
											</td>
										</tr> 
								...
								<div class="button">
									<a href="javascript:frm.submit();" class="estBtn">올리기</a>
								</div>
					...
					<textarea id="subject" name="subject" placeholder="내용을 입력해 주세요" style="width:100%; height:150px"></textarea> -->
