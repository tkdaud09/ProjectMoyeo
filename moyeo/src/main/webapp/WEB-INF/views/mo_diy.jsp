              ...
              <div class="search-box">
                <form class="mb-0" action="index.html" method="post">
                  <div class="input-group input-group-sm">
                    <input type="text" class="form-control form-control-sm rounded-0" required="" placeholder="ê²ìì´ë¥¼ ìë ¥íì¸ì" aria-label="ê²ìì´ë¥¼ ìë ¥íì¸ì">
                    <button class="btn bg-primary border-0 rounded-0" type="submit">
                      <span class="text-white text-uppercase font-weight-bold">ê²ì</span>
                    </button>
                  </div>
                </form>
              </div>
      ...
      <div class="container clearfix">
        <div id="menuzord" class="menuzord">
          ...
          <ul class="menuzord-menu menuzord-right">
            ...
            <li class="">
              <a class="" href="javascript:void(0)">í¨í¤ì§ì¬í</a>
              <ul class="dropdown drop-up">
                <li class=" ">
                  <a href="mo_package.html">í¨í¤ì§ì¬í</a>
                </li>
              </ul>
            </li>
            ...
            <li class="active">
              ...
              <ul class="dropdown drop-up">
				...
				<li class=" ">
                  <a href="mo_diy_form.html">DIY ì°¸ì¬íê¸°</a>
                </li>
				<li class=" ">
                  <a href="mo_diy_list.html">DIY ì ì²´ë³´ê¸°</a>
                </li>
              </ul>
            </li>
              ...
              <li class="">
				<a class="" href="javascript:void(0)">ì´ë²¤í¸</a>
              <ul class="dropdown drop-up">
                <li class=" ">
                  <a href="mo_event.html">ì´ë²¤í¸</a>
                </li>
              </ul>
            </li>

            <li class="">
              <a href="javascript:void(0)">íê¸°</a>
              <ul class="dropdown drop-up">
                <li class="">
                  <a href="mo_review.html">íê¸°</a>
                </li>
        ...
        <div class="col-lg-6">
          <div class="page-title-content">
            <div class="title-border">
              <h2 class="text-uppercase text-white font-weight-bold">ëë§ì DIY ì¬í</h2>
            </div>
  ...
  <div class="container">
		<div class="py-10">
			<div class="diy_content">
				...
				<div class="div_con1">
					<p class="p1">ë°°ë ì´ë¯¸ì§ê° ë¤ì´ê° ê³µê°ìëë¤</p>
					<p class="div_title">ê³µìí¨í¤ì§</p>
					<div class="div_p">
						<div class="div_pack1 sp">
							<div class="div_pack1_img">
							</div>
							<div class="div_pack1_text af">
								<p class="t1">ê³µìí¨í¤ì§ ì ëª©ì´ ë¤ì´ê° ê³µê°ìëë¤</p>
								<p class="t2">ê³µìí¨í¤ì§ íì¤í¸ ê³µê° ê³µìí¨í¤ì§ íì¤í¸ ê³µê° ê³µìí¨í¤ì§ íì¤í¸ ê³µê° ê³µìí¨í¤ì§ íì¤í¸ ê³µê° ê³µìí¨í¤ì§ íì¤í¸ ê³µê° ê³µìí¨í¤ì§ íì¤í¸ ê³µê° ê³µìí¨í¤ì§ íì¤í¸ ê³µê° ê³µìí¨í¤ì§ íì¤í¸ ê³µê°</p>
								<div class="t_left">
									<p class="t1">ì¶ë°ê°</p>
									<p class="t2">300,000ì~</p>
								</div>
								<div class="t_right">
									<a href="#"><button>ìì¸íë³´ê¸°</button></a>
								</div>
							</div>
						</div>
						...
						<div class="div_pack1">
						 ...
						 <div class="div_btn1">
							<a href="mo_diy_form.html"><button>ì°¸ì¬íê¸°</button></a>
						</div>
			...
			<div class="div_con2">
				<div class="div_list_sample">
					...
					<div class="dls_right">
						<ul>
							<a href="#"><li class="l1">DIY í¨í¤ì§ ìí ì ì²´ ë¦¬ì¤í¸ ìí ì ëª©ì´ ë¤ì´ê° ê³µê°</li></a>
							<li class="l2">íì¤í¸ê° ë¤ì´ê° ê³µê°ìëë¤ íì¤í¸ê° ë¤ì´ê° ê³µê°ìëë¤ íì¤í¸ê° ë¤ì´ê° ê³µê°ìëë¤  íì¤í¸ê° ë¤ì´ê° ê³µê°ìëë¤. íì¤í¸ê° ë¤ì´ê° ê³µê°ìëë¤ íì¤í¸ê° ë¤ì´ê° ê³µê°ìëë¤ íì¤í¸ê° ë¤ì´ê° ê³µê°ìëë¤  íì¤í¸ê° ë¤ì´ê° ê³µê°ìëë¤</li>
							<li class="l3">ê¹*ì &nbsp&nbsp&nbsp 2023-08-17</li>
						</ul>
					</div><!-- /dls_right -->
				</div><!-- /div_list_sample -->
	...
	<div class="footer_In">
		...
		<div class="f_in">
			<div class="info">
				<ul>
					<a href="#"><li>êµ­ë´ì¬í íì¤ì½ê´</li></a>
					<a href="#"><li>ì´ì©ì½ê´</li></a>
					<a href="#"><li>ê°ì¸ì ë³´ ì²ë¦¬ë°©ì¹¨</li></a>
				</ul>
			</div><!--info-->
			
			
			<p class="p1">
				<span>ìí¸ëª</span> : ëª¨ëì ì¬í &nbsp;ï½&nbsp;  
				<span>ì£¼ì</span> : ìì¸ ê°ë¨êµ¬ íí¤ëë¡ 124 4ì¸µ  &nbsp;ï½&nbsp;  
				<span>ëíë²í¸</span> : 000-000-0000  &nbsp;ï½&nbsp;  
				<span>ì´ë©ì¼</span> : moyeo@moyeo.com<br>
				â 2023. MOYEO lnc. ALL RIGHT RESERVED</p>
      ...
      <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer justify-content-center">
            <p class="mb-1">Donât have an Account? <a href="javascript:void(0)">Sign up</a></p>
          </div>
        </div>
      </div>
    </div>
