        ...
        <div class="diy_tit_t">${diyDetail.diyIntroduction }</div>
            ...
            <div class="diy_con2">
                <label for="diyPeople">인원
                  <input type="text" class="form-control border-0 bg-smoke" id="diyPeople" name="diyPeople" value="${diyDetail.diyPeople }명" readonly>
                </label>
                <label for="diyLoc">지역
                ...
                <label for="diyPrice">비용
                  <input type="text" class="form-control border-0 bg-smoke" id="diyPrice" name="diyPrice" value="${diyDetail.diyPrice }원" readonly>
                </label>
            </div>
          ...
          <!-- day 2 사진 -->
          <c:if test="${diyDetail.diyContent2 ne null}">
          <div class="diy_con4 form-group">
          ...
          <!-- day 3 사진 -->
          <c:if test="${diyDetail.diyContent3 ne null}">
          <div class="diy_con4 form-group">
          ...
          <!-- day 4 사진 -->
          <c:if test="${diyDetail.diyContent4 ne null}">
          <div class="diy_con4 form-group">
