...
<section class="">
  <div class="container">
			...
			<div class="review_content">
				...
				<form class="w_f" action="${pageContext.request.contextPath}/qa/modify/${qa.qaIdx}" method="post" id="enrollForm" enctype="multipart/form-data">		   	
					    <p>작성자</p>
					    ...
					    <p>제목</p>
					    <input class="text" type="text" name="qaTitle" placeholder="제목" value="${qa.qaTitle }">
					   
					    <p>내용</p>
					    <textarea name="qaContent" placeholder="내용">${qa.qaContent }</textarea>
