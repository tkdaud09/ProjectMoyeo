	...
	<body id="body" class="up-scroll">
	    ...
	    <div class="admin_content_subject"><span>이벤트 등록</span></div>
	    <div class="admin_content_main">
	         <form action="addEvent" method="post" id="enrollForm"  enctype="multipart/form-data">
	            <div class="form_section">
	                <div class="form_section_title">
	                    <label>제목</label>
	                </div>
	                <div class="form_section_content">
	                    <input name="eventTitle" placeholder="ex) 이벤트 제목을 입력하세요">
	                </div>
	            </div>
	            ...
	            <div class="form_section">
	                             ...
	                             <div class="form_section_content">
	                                <input type="date" name="eventStartdate" id="fundingStart" 
	            ...
	            <div class="form_section">
	                             ...
	                             <div class="form_section_content">
	                                <input type="date" name="eventEnddate" id="fundingEnd" 
	                                class="form-control festival-form-control">
	                             </div>
	                          </div>
	            ...
	            <div class="form_section">
	                ...
	                <div class="form_section_content">
	                    <textarea name="eventContent" rows="4" placeholder="ex) 이벤트 내용을 입력하세요"></textarea>
	                </div>
	            </div>
	            </div>
				<br>
